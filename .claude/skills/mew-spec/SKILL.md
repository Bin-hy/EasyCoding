---
name: mew-spec
description: "Spec 驱动开发：通过协作式需求澄清，依次生成 spec.md → plan.md → task.md → checklist.md，然后指导开发和验收。在开始任何功能、模块或章节开发前使用。当你想要开发新功能、添加新模块、或开始任何代码实现任务时，务必先触发这个 skill。"
user-invocable: true
---
...
向用户呈现审批提示，等待用户明确批准。如果用户要求修改，修改后重新审批。
